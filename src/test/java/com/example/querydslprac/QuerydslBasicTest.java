...
import com.example.querydslprac.dto.MemberDto;
import com.example.querydslprac.dto.QMemberDto;
...
import static com.example.querydslprac.entity.QMember.*;
import static com.example.querydslprac.entity.QTeam.team;
...
public class QuerydslBasicTest {
     ...
     * 1. 회원 나이 내림차순(desc)
     * 2. 회원 이름 오름차순(asc)
     * 단 2에서 회언 이름이 없으면 마지막에 출력(null last)
     */
    ...
    /**
     * QueryDsl을 사용해서 프로젝션 반환 결과값을 Dto로 조회
     */
    ...
    /**
     * 생성자 방식을 사용했을 시 만약 오류가 났을 떄 런타임 오류가 발생.
     */
    @Test
    ...
    /**
     * QueryProjection을 사용했을 시 오류가 났을 때 컴파일 오류가 발생.
     */
    @Test
    ...
    /**
     * bulk update
     * 벌크 연산은 JPA의 영속성 컨텍스트를 무시하고 쿼리를 날려버린다.
     * 그러므로 db와 영속성 컨텍스트와의 데이터 불일치 발생
     *
     */
